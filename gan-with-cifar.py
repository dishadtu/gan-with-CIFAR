...
entrenamiento(dataset, modelo_generador, modelo_discriminador, epochs = 150, n_batch=128, inicio = 0) #epochs=100 ..  have changed to make it faster
...
for i in range(49):
  ...
  # Save the plot
plt.savefig('my_image150epoch.png')
plt.show()
